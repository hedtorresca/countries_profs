...
countriesmapsede <- countriesmapsede %>%
  ...
  addEasyButton(easyButton(
    ...
    onClick = JS("function(btn ,  map){ map.setView(L.latLng(42.796626414 , 12.07001339) ,  2); }")))%>%
  addLabelOnlyMarkers(lat = ~LATITUD,  lng = ~LONGITUD , label =  ~paste0(countries$NOMBRE) ,   labelOptions = labelOptions(noHide = T ,  direction = 'top' ,  textOnly = T , textsize = "10px") )%>%
  addAwesomeMarkers(lat=sedes[Sede == "Medellín",]$latitud, lng=sedes[Sede == "Medellín",]$longitud, icon = sedeIcon, label= label_sede[[1]], labelOptions=labelOptions(     style = list("font-weight" = "large", padding = "3px 8px"),  textsize = "15px", direction = "auto"), group = "Medellín"  )%>%
  addAwesomeMarkers(lat=sedes[Sede == "Bogotá",]$latitud, lng=sedes[Sede == "Bogotá",]$longitud, icon = sedeIcon, label= label_sede[[2]], labelOptions=labelOptions(     style = list("font-weight" = "large", padding = "3px 8px"),  textsize = "15px", direction = "auto"), group = "Bogotá"  )%>%
  addAwesomeMarkers(lat=sedes[Sede == "Palmira",]$latitud, lng=sedes[Sede == "Palmira",]$longitud, icon = sedeIcon, label= label_sede[[5]], labelOptions=labelOptions(     style = list("font-weight" = "large", padding = "3px 8px"),  textsize = "15px", direction = "auto"), group = "Palmira"  )%>%
  addAwesomeMarkers(lat=sedes[Sede == "Amazonas",]$latitud, lng=sedes[Sede == "Amazonas",]$longitud, icon = sedeIcon, label= label_sede[[8]], labelOptions=labelOptions(     style = list("font-weight" = "large", padding = "3px 8px"),  textsize = "15px", direction = "auto"), group = "Amazonía"  )%>%
  addAwesomeMarkers(lat=sedes[Sede == "Caribe",]$latitud, lng=sedes[Sede == "Caribe",]$longitud, icon = sedeIcon, label= label_sede[[7]], labelOptions=labelOptions(     style = list("font-weight" = "large", padding = "3px 8px"),  textsize = "15px", direction = "auto"), group = "Caribe"  )%>%
  addAwesomeMarkers(lat=sedes[Sede == "Manizales",]$latitud, lng=sedes[Sede == "Manizales",]$longitud, icon = sedeIcon, label= label_sede[[3]], labelOptions=labelOptions(     style = list("font-weight" = "large", padding = "3px 8px"),  textsize = "15px", direction = "auto"), group = "Manizales"  )%>%
  addAwesomeMarkers(lat=sedes[Sede == "Arauca",]$latitud, lng=sedes[Sede == "Arauca",]$longitud, icon = sedeIcon, label= label_sede[[6]], labelOptions=labelOptions(     style = list("font-weight" = "large", padding = "3px 8px"),  textsize = "15px", direction = "auto"), group = "Orinoquía"  )%>%
  showGroup("Todas")%>%
  hideGroup("Medellín")%>%
  hideGroup("Bogotá")%>%
  hideGroup("Palmira")%>%
